...
#
# Generated by export_simulation on Sat Sep 28 20:38:11 -0600 2019
#
################################################################################
...
'-reset_run' switch to the './PEtest.sh' script.
...
./PEtest.sh -noclean_files

For more information on the script, please type './PEtest.sh -help'.
